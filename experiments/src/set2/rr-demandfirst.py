...
class Topo(IPTopo):
    def build(self, *args, **kwargs):
        ...
        #DemandFirst
        self.addLink(hosts[1], hosts[0], igp_metric=1000, bw=200, delay="5ms")
        self.addLink(hosts[6], hosts[2], igp_metric=1000, bw=200, delay="5ms")
...
tasks = {
    ...
    'h0': [('h6', 1458)],
    'h8': [('h1', 1105), ('h4', 1335)],
    'h1': [('h5', 812), ('h3', 1057), ('h2', 1339), ('h7', 1828), ('h0', 1971)],
    'h5': [('h8', 922), ('h1', 1152)],
    'h2': [('h7', 403), ('h3', 1381)]
}
