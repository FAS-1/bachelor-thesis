...
def initialize_tasks():
    tasks = {
        ...
        'h7': [('h6', 911, 4)],
        'h6': [('h8', 1642, 3)],
        'h4': [('h3', 278, 2), ('h7', 889, 3)],
        'h0': [('h4', 1118, 4), ('h9', 1355, 3), ('h5', 1572, 5), ('h6', 1631, 5)],
        'h3': [('h7', 1449, 4)],
        'h8': [('h4', 153, 3)],
        'h1': [('h6', 641, 2), ('h0', 1152, 5)],
        'h5': [('h4', 288, 5), ('h0', 1615, 5), ('h2', 1769, 3), ('h9', 2047, 4)],
        'h2': [('h9', 472, 2), ('h5', 477, 5), ('h8', 1664, 1)]
    }
    return tasks
