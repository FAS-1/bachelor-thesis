...
class Topo(IPTopo):
    def build(self, *args, **kwargs):
        ...
        self.addLink(hosts[1], hosts[2], igp_metric=1000, bw=200, delay="5ms")
...
def initialize_tasks():
    tasks = {
        'h9': [('h3', 1426, 2)],
        'h7': [('h9', 653, 2)],
        'h6': [('h9', 620, 1), ('h2', 841, 5)],
        'h4': [('h8', 1126, 3), ('h5', 1322, 4)],
        'h0': [('h1', 1747, 5)],
        'h3': [('h2', 881, 5), ('h8', 980, 5)],
        'h8': [('h3', 416, 4), ('h2', 656, 4), ('h0', 1129, 5)],
        'h1': [('h5', 734, 3), ('h2', 1999, 2)],
        'h5': [('h7', 687, 4), ('h3', 923, 4)],
        'h2': [('h4', 450, 4), ('h9', 1258, 3), ('h7', 1272, 5), ('h1', 1997, 3)]
    }
    return tasks
