...
def initialize_tasks():
    tasks = {
        'h9': [('h0', 2021, 2), ('h7', 1531, 2), ('h3', 989, 5)],
        'h7': [('h1', 1358, 3)],
        'h6': [('h9', 571, 2), ('h1', 988, 4)],
        'h4': [('h1', 2027, 2)],
        'h0': [('h9', 156, 3), ('h8', 364, 1)],
        'h3': [('h2', 460, 3), ('h8', 1194, 2)],
        'h1': [('h9', 1834, 2), ('h0', 2005, 1)],
        'h5': [('h6', 653, 5), ('h7', 296, 1), ('h3', 756, 5)],
        'h2': [('h9', 469, 4), ('h5', 431, 1), ('h4', 1434, 4), ('h6', 1779, 1)]
    }
    return tasks
