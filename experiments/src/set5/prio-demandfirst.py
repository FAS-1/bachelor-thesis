...
class Topo(IPTopo):
    def build(self, *args, **kwargs):
        ...
        self.addLink(hosts[6], hosts[3], igp_metric=1000, bw=200, delay="5ms")
...
def initialize_tasks():
    tasks = {
        'h2': [('h8', 666, 3), ('h1', 1157, 5), ('h5', 1293, 4)],
        'h7': [('h5', 404, 4), ('h9', 1410, 3), ('h6', 1736, 5)],
        'h6': [('h2', 975, 5), ('h7', 1374, 4), ('h3', 1865, 5), ('h8', 1902, 1)],
        'h4': [('h8', 629, 4)],
        'h0': [('h7', 270, 5)],
        'h3': [('h4', 988, 2), ('h7', 1399, 5)],
        'h8': [('h9', 1916, 3)],
        'h1': [('h2', 398, 3)],
        'h5': [('h4', 323, 3), ('h9', 435, 2), ('h1', 1007, 2), ('h0', 1266, 4)]
    }
    return tasks
