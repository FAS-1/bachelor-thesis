...
def generate_combined_box_plot(base_folder, set_names, output_file):
    ...
    for set_name in set_names:
        ...
        for experiment_dir in os.listdir(set_path):
            ...
            if os.path.isdir(experiment_path):
                csv_file = os.path.join(experiment_path, 'result_average_longest_completion_time_without_pause.csv')
                if os.path.isfile(csv_file):
                    ...
                    if 'Longest Completion Time (seconds)' in df.columns:
                        ...
                        if experiment_dir.startswith('rr') or experiment_dir.startswith('prio'):
                            rr_prio_data[experiment_dir].append(average_completion_time)
    ...
    axs[1].set_title('Distribution of Average Longest Completion Times for rr and prio Experiments')
